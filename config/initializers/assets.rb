...
Rails.application.config.assets.precompile += %w( jquery.ajaxchimp.langs.js)
...
Rails.application.config.assets.precompile += %w( mapview.js)


Rails.application.config.assets.precompile += %w( mapview.css)
